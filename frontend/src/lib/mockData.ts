...
import { aiToTiptapJson } from "@/features/tenders/utils/tenderJsonToTiptap";
...
const INIT_KEY = "mock_initialized_v4";
  ...
  return [
    {
      ...
      htmlContent: generateHTML(aiToTiptapJson(t1ai), [StarterKit]),
    },
    {
      ...
      htmlContent: generateHTML(aiToTiptapJson(t2ai), [StarterKit]),
    },
    {
      ...
      htmlContent: generateHTML(aiToTiptapJson(t3ai), [StarterKit]),
    },
  ];
}
  ...
  const apps: StoredApplication[] = [
    {
      ...
      documents: [
        {
          docName: "Company Registration Certificate", fileName: "registration.pdf", size: 1024000,
          verification: { verified: true, confidence: 96, message: "Matched — Registration No. found and verified", extractedData: {} }
        },
        {
          docName: "GST Certificate", fileName: "gst.pdf", size: 512000,
          verification: { verified: true, confidence: 91, message: "Matched — GST No. 09ABCDE1234F1Z5 found and verified", extractedData: {} }
        },
        {
          docName: "PAN Card", fileName: "pan.pdf", size: 256000,
          verification: { verified: true, confidence: 89, message: "Matched — PAN ABCDE1234F matches form entry", extractedData: {} }
        }
      ],
      match: {
        totalScore: 82, verdict: "UNDER_REVIEW",
        breakdown: {
    ...
    },
    {
      ...
      documents: [
        {
          docName: "Company Registration Certificate", fileName: "reg_cert_nextgen.pdf", size: 1200000,
          verification: { verified: true, confidence: 98, message: "Matched — Registration No. found and verified", extractedData: {} }
        },
        {
          docName: "GST Certificate", fileName: "gst_cert.pdf", size: 450000,
          verification: { verified: true, confidence: 94, message: "Matched — GST No. 27FGHIJ5678K2L6 found and verified", extractedData: {} }
        },
        {
          docName: "PAN Card", fileName: "pan_card.pdf", size: 300000,
          verification: { verified: false, confidence: 72, message: "Mismatch — PAN on document (FGHIJ5678X) does not match form entry (FGHIJ5678K)", extractedData: {} }
        }
      ],
      match: {
    ...
    },
    {
      ...
      documents: [
        {
          docName: "GST Certificate", fileName: "gst_certificate_final.pdf", size: 600000,
          verification: { verified: false, confidence: 65, message: "Mismatch — Document blurry or invalid format", extractedData: {} }
        }
      ],
      match: {
        ...
        missing: ["PAN card", "Incorporation certificate", "Experience proofs", "Turnover proofs"],
        strengths: ["Low quoted price"],
        concerns: ["Virtually no documents provided to verify claims", "Very low experience"],
        priceFit: "Suspiciously Low",
        summary: "Application lacks basic documentation and experience to qualify for this tender.",
      } satisfies MatchEvaluation,
    },
    {
      id: "app-004", tenderId: "TND-2026-1001",
      vendorId: "v4-mock", vendorName: "National Office Supplies",
      createdAt: "2026-06-16T11:00:00.000Z",
      form: vendorForm(v3, {
        companyName: "National Office Supplies", orgType: "Pvt Ltd", gst: "33ABCDE1234F1Z5", pan: "ABCDE1234F",
        yearEstablished: "2010", yearsInBusiness: "14", employees: "201-500",
        turnover: "150", certifications: "ISO 9001, BIFMA",
        categoryExperience: "10", projectCount: "45",
        technicalCapability: "Large scale manufacturing with dedicated logistics.",
        qualityStandards: "High",
        quotedPrice: "390000", timeline: "14",
        whyUs: "Best in class",
      }),
      documents: [
        {
          docName: "Company Registration Certificate", fileName: "inc_cert.pdf", size: 850000,
          verification: { verified: true, confidence: 97, message: "Matched — Incorporation verified", extractedData: {} }
        },
        {
          docName: "GST Certificate", fileName: "gst_cert.pdf", size: 450000,
          verification: { verified: true, confidence: 95, message: "Matched — GST No. 33ABCDE1234F1Z5 found", extractedData: {} }
        },
        {
          docName: "PAN Card", fileName: "pan.pdf", size: 300000,
          verification: { verified: true, confidence: 92, message: "Matched — PAN ABCDE1234F verified", extractedData: {} }
        }
      ],
      match: {
        totalScore: 94, verdict: "UNDER_REVIEW",
        breakdown: {
          eligibility: { score: 25, remark: "Excellent" },
          technical: { score: 25, remark: "Excellent" },
          experience: { score: 20, remark: "Extensive experience" },
          financial: { score: 15, remark: "Lowest price" },
          documents: { score: 9, remark: "All documents verified" },
        },
        matched: ["GST", "PAN", "Turnover", "Experience", "Price"],
        missing: [],
        strengths: ["Lowest price", "Highest experience"],
        concerns: [],
        priceFit: "Lowest",
        summary: "Strongest application overall. Highly recommended.",
      } satisfies MatchEvaluation,
    },
    {
      id: "app-005", tenderId: "TND-2026-1001",
      vendorId: "v5-mock", vendorName: "Rapid Furniture Co.",
      createdAt: "2026-06-17T15:30:00.000Z",
      form: vendorForm(v3, {
        companyName: "Rapid Furniture Co.", orgType: "Proprietorship", gst: "11XYZDE1234F1Z5", pan: "XYZDE1234F",
        yearEstablished: "2022", yearsInBusiness: "2", employees: "11-50",
        turnover: "15", certifications: "None",
        categoryExperience: "2", projectCount: "5",
        technicalCapability: "Quick delivery.",
        qualityStandards: "Average",
        quotedPrice: "520000", timeline: "7",
        whyUs: "Fastest delivery timeline.",
      }),
      documents: [
        {
          docName: "Company Registration Certificate", fileName: "reg.pdf", size: 250000,
          verification: { verified: true, confidence: 90, message: "Matched", extractedData: {} }
        },
        {
          docName: "GST Certificate", fileName: "gst.pdf", size: 150000,
          verification: { verified: true, confidence: 85, message: "Matched", extractedData: {} }
        }
      ],
      match: {
        totalScore: 52, verdict: "UNDER_REVIEW",
        breakdown: {
          eligibility: { score: 12, remark: "Low experience" },
          technical: { score: 10, remark: "Average" },
          experience: { score: 10, remark: "Below requirement" },
          financial: { score: 12, remark: "Above budget" },
          documents: { score: 8, remark: "Documents verified" },
        },
        matched: ["GST", "Timeline"],
        missing: ["Experience", "Turnover"],
        strengths: ["Fast timeline"],
        concerns: ["Price too high", "Low experience"],
        priceFit: "Above budget",
        summary: "Fast timeline but expensive and inexperienced.",
      } satisfies MatchEvaluation,
    },

    {
      ...
      documents: [],
      match: {
        totalScore: 88, verdict: "UNDER_REVIEW",
        breakdown: {
