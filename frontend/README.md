...
Tender Management is a next-generation, AI-driven platform that revolutionizes the way companies create tenders and vendors apply for them. By leveraging the **Google Gemini API**, **Groq**, and **OCR technology**, Tender Management automatically parses, evaluates, and scores vendor applications against complex tender requirements—saving hundreds of hours of manual review.
...
- **State Management**: React Hook Form, Custom Stores
...
```sql
CREATE DATABASE Tender Management;
```
